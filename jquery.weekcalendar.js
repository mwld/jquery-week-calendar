...
//              calendarHeaderHtml+=    "</div>";
            ...
            _drawCurrentHourLine: function() {
                ...
                var lineWidth = $('.wc-scrollable-grid .wc-today', this.element).width();
                var lineWidthTime = $('.wc-grid-timeslot-header', this.element).width();
                ...
                $('.wc-grid-timeslot-header', this.element).append(
                    $('<div>', {
                        'class': 'wc-hourline',
                        style: 'top: ' + positionTop + 'px; width: ' + lineWidthTime + 'px'
                    })
                );
            },
